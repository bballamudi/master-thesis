...
control.
Finally, our sample-efficient methodology allows us to reach better or 
equivalent performance in up to two orders of magnitude less samples than DQN on
...
first column of\footnote{i.e.\ the first elements of each four-tuple in -} a 
