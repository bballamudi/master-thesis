...
\cite{sutton1998reinforcement} for more details on the subject of non-finite 
MDPs.}, it is possible to define the concept of \textit{optimal policy} as the 
policy that maximizes the expected return collected by the agent in an episode.
